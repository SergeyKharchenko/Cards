...
if (!window['google']['loader']) {
    ...
    (function() {
        ...
        function D(a) { return a in E ? E[a] : E[a] = -1 != navigator.userAgent[C]()[u](a) }
        ...
        function G(a, b, c) {
            ...
            return function() { return a.apply(b, e.concat(Array[y].slice.call(arguments))) }
        }
        ...
        l(google, function(a, b, c) {
            ...
            var f = a;
            c = c || {};
            if (a instanceof Array || a && "object" == typeof a && "function" == typeof a[B] && "function" == typeof a.reverse) for (var k = 0; k < a[x]; k++) e(a[k]);
            else e(a);
            if (a = M[":" + f]) {
        ...
        google.T = function(a, b) { b ? (0 == O[x] && (P(g, "load", Q), !D("msie") && !D("safari") && !D("konqueror") && D("mozilla") || g.opera ? g.addEventListener("DOMContentLoaded", Q, !1) : D("msie") ? h.write("<script defer onreadystatechange='google.loader.domReady()' src=//:>\x3c/script>") : (D("safari") || D("konqueror")) && g[r](S, 10)), O[t](a)) : P(g, "load", a) };
        ...
        function aa(a) { return function() { for (var b = 0; b < a[x]; b++) a[b]() } }
        ...
        function S() { ba[h.readyState] ? Q() : 0 < O[x] && g[r](S, 10) }
        ...
        google[z].S = function(a) { for (var b in a) "string" == typeof b && b && ":" == b[n](0) && !M[b] && (M[b] = new T(b[A](1), a[b])) };
        ...
        google[z].O = function() { return "qid=" + ((new Date)[q]().toString(16) + Math.floor(1E7 * Math.random()).toString(16)) };
        ...
        U[y].t = function(a) {
            ...
            if (b)
                ...
                else if (b[x]) for (c = [], a = 0; a < b[x]; a++) "string" == typeof b[a] && c[t](b[a][m](/^\s*|\s*$/, "")[C]());
            c || (c = ["default"]);
            b = [];
        ...
        U[y].m = function(a, b) { return 0 == this.t(b)[x] };
        U[y].s = function() { return !0 };
        ...
        W[y].C = function(a) { this.q[":" + a] && (this.q[":" + a] = !1, this.r--, 0 == this.r && g[r](this.F, 0)) };
        ...
        V[y].m = function(a, b) { return b && null != b.callback ? this.u : this.h };
        V[y].l = function() {
            this.u = !0;
            for (var a = 0; a < this.k[x]; a++) g[r](this.k[a], 0);
            this.k = []
        };
        var Y = function(a, b) { return a.string ? d(a.string) + "=" + d(b) : a.regex ? b[m](/(^.*$)/, a.regex) : "" };
        V[y].g = function(a, b) { return this.G(this.w(a), a, b) };
        ...
        V[y].s = function(a) { return this.w(a).deferred };
        V[y].w = function(a) {
            if (this.p)
        ...
        T[y].s = function() { return !1 };
        var ca = !1,
            Z = [],
            da = (new Date)[q](),
            fa = function() { ca || (P(g, "unload", ea), ca = !0) },
            ga = function(a, b) {
                fa();
            ...
            X = function(a, b, c) { c ? ga([a], [b]) : (fa(), Z[t]("r" + Z[x] + "=" + d(a + (b ? "|" + b : ""))), g[r](ea, 5 < Z[x] ? 0 : 15E3)) },
            ea = function() {
                if (Z[x]) {
                    var a =
                        google[z][v];
